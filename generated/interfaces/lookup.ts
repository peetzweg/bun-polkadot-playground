...
export default {
  ...
  /**
   * Lookup43: polkadot_runtime_common::impls::VersionedLocatableAsset
   **/
  ...
  /**
   * Lookup44: staging_xcm::v3::multilocation::MultiLocation
   **/
  ...
  /**
   * Lookup45: xcm::v3::junctions::Junctions
   **/
  XcmV3Junctions: {
    _enum: {
      Here: 'Null',
  ...
  /**
   * Lookup46: xcm::v3::junction::Junction
   **/
  XcmV3Junction: {
    _enum: {
  ...
  /**
   * Lookup49: xcm::v3::junction::NetworkId
   **/
  ...
  /**
   * Lookup54: xcm::v3::multiasset::AssetId
   **/
  ...
  /**
   * Lookup55: xcm::VersionedMultiLocation
   **/
  ...
  /**
   * Lookup56: xcm::v2::multilocation::MultiLocation
   **/
  XcmV2MultiLocation: {
    parents: 'u8',
  ...
  /**
   * Lookup57: xcm::v2::multilocation::Junctions
   **/
  ...
  /**
   * Lookup58: xcm::v2::junction::Junction
   **/
  XcmV2Junction: {
    _enum: {
      Parachain: 'Compact<u32>',
  ...
  /**
   * Lookup66: frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>
   **/
  ...
  /**
   * Lookup73: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, Hash>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup75: sp_consensus_babe::app::Public
   **/
  ...
  /**
   * Lookup78: sp_session::MembershipProof
   **/
  ...
  /**
   * Lookup79: sp_consensus_babe::digests::NextConfigDescriptor
   **/
  ...
  /**
   * Lookup81: sp_consensus_babe::AllowedSlots
   **/
  ...
  /**
   * Lookup83: pallet_indices::pallet::Call<T>
   **/
  PalletIndicesCall: {
    _enum: {
      claim: {
  ...
  /**
   * Lookup88: pallet_balances::pallet::Call<T, I>
   **/
  PalletBalancesCall: {
    _enum: {
  ...
  /**
   * Lookup90: pallet_beefy::pallet::Call<T>
   **/
  PalletBeefyCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup91: sp_consensus_beefy::EquivocationProof<Number, sp_consensus_beefy::ecdsa_crypto::Public, sp_consensus_beefy::ecdsa_crypto::Signature>
   **/
  ...
  /**
   * Lookup92: sp_consensus_beefy::ecdsa_crypto::Public
   **/
  SpConsensusBeefyEcdsaCryptoPublic: 'SpCoreEcdsaPublic',
  /**
   * Lookup93: sp_core::ecdsa::Public
   **/
  SpCoreEcdsaPublic: '[u8;33]',
  /**
   * Lookup95: sp_consensus_beefy::ecdsa_crypto::Signature
   **/
  SpConsensusBeefyEcdsaCryptoSignature: 'SpCoreEcdsaSignature',
  /**
   * Lookup96: sp_core::ecdsa::Signature
   **/
  SpCoreEcdsaSignature: '[u8;65]',
  /**
   * Lookup98: sp_consensus_beefy::VoteMessage<Number, sp_consensus_beefy::ecdsa_crypto::Public, sp_consensus_beefy::ecdsa_crypto::Signature>
   **/
  ...
  /**
   * Lookup99: sp_consensus_beefy::commitment::Commitment<TBlockNumber>
   **/
  ...
  /**
   * Lookup100: sp_consensus_beefy::payload::Payload
   **/
  SpConsensusBeefyPayload: 'Vec<([u8;2],Bytes)>',
  /**
   * Lookup104: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
  ...
  /**
   * Lookup105: rococo_runtime::SessionKeys
   **/
  ...
  /**
   * Lookup106: polkadot_primitives::v6::validator_app::Public
   **/
  PolkadotPrimitivesV6ValidatorAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup107: polkadot_primitives::v6::assignment_app::Public
   **/
  PolkadotPrimitivesV6AssignmentAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup108: sp_authority_discovery::app::Public
   **/
  SpAuthorityDiscoveryAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup109: pallet_grandpa::pallet::Call<T>
   **/
  PalletGrandpaCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup110: sp_consensus_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup111: sp_consensus_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup112: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup113: finality_grandpa::Prevote<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup114: sp_consensus_grandpa::app::Signature
   **/
  SpConsensusGrandpaAppSignature: 'SpCoreEd25519Signature',
  /**
   * Lookup115: sp_core::ed25519::Signature
   **/
  SpCoreEd25519Signature: '[u8;64]',
  /**
   * Lookup118: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup119: finality_grandpa::Precommit<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup121: pallet_treasury::pallet::Call<T, I>
   **/
  PalletTreasuryCall: {
    _enum: {
      propose_spend: {
  ...
  /**
   * Lookup123: pallet_conviction_voting::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup126: pallet_conviction_voting::conviction::Conviction
   **/
  PalletConvictionVotingConviction: {
    _enum: ['None', 'Locked1x', 'Locked2x', 'Locked3x', 'Locked4x', 'Locked5x', 'Locked6x']
  },
  /**
   * Lookup128: pallet_referenda::pallet::Call<T, I>
   **/
  PalletReferendaCall: {
    _enum: {
      submit: {
  ...
  /**
   * Lookup129: rococo_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup130: frame_support::dispatch::RawOrigin<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup131: rococo_runtime::governance::origins::pallet_custom_origins::Origin
   **/
  ...
  SpCoreVoid: 'Null',
  /**
   * Lookup136: frame_support::traits::schedule::DispatchTime<BlockNumber>
   **/
  ...
  /**
   * Lookup138: pallet_ranked_collective::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup140: pallet_whitelist::pallet::Call<T>
   **/
  PalletWhitelistCall: {
    _enum: {
      whitelist_call: {
  ...
  /**
   * Lookup141: polkadot_runtime_common::claims::pallet::Call<T>
   **/
  ...
  /**
   * Lookup142: polkadot_runtime_common::claims::EcdsaSignature
   **/
  PolkadotRuntimeCommonClaimsEcdsaSignature: '[u8;65]',
  /**
   * Lookup147: polkadot_runtime_common::claims::StatementKind
   **/
  ...
  /**
   * Lookup151: pallet_identity::pallet::Call<T>
   **/
  PalletIdentityCall: {
    _enum: {
      add_registrar: {
  ...
  /**
   * Lookup152: pallet_identity::legacy::IdentityInfo<FieldLimit>
   **/
  ...
  /**
   * Lookup189: pallet_society::pallet::Call<T, I>
   **/
  PalletSocietyCall: {
    _enum: {
      bid: {
  ...
  /**
   * Lookup190: pallet_recovery::pallet::Call<T>
   **/
  PalletRecoveryCall: {
    _enum: {
      as_recovered: {
  ...
  /**
   * Lookup191: pallet_vesting::pallet::Call<T>
   **/
  PalletVestingCall: {
    _enum: {
      vest: 'Null',
  ...
  /**
   * Lookup192: pallet_vesting::vesting_info::VestingInfo<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup198: rococo_runtime::ProxyType
   **/
  ...
  /**
   * Lookup201: pallet_multisig::Timepoint<BlockNumber>
   **/
  ...
  /**
   * Lookup202: pallet_preimage::pallet::Call<T>
   **/
  PalletPreimageCall: {
    _enum: {
      note_preimage: {
  ...
  /**
   * Lookup204: pallet_asset_rate::pallet::Call<T>
   **/
  PalletAssetRateCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup206: pallet_bounties::pallet::Call<T, I>
   **/
  PalletBountiesCall: {
    _enum: {
      propose_bounty: {
  ...
  /**
   * Lookup207: pallet_child_bounties::pallet::Call<T>
   **/
  ...
  /**
   * Lookup208: pallet_nis::pallet::Call<T>
   **/
  PalletNisCall: {
    _enum: {
      place_bid: {
  ...
  /**
   * Lookup212: polkadot_runtime_parachains::configuration::pallet::Call<T>
   **/
  ...
  /**
   * Lookup213: polkadot_primitives::v6::async_backing::AsyncBackingParams
   **/
  ...
  /**
   * Lookup214: polkadot_primitives::v6::executor_params::ExecutorParams
   **/
  PolkadotPrimitivesV6ExecutorParams: 'Vec<PolkadotPrimitivesV6ExecutorParamsExecutorParam>',
  /**
   * Lookup216: polkadot_primitives::v6::executor_params::ExecutorParam
   **/
  ...
  /**
   * Lookup217: polkadot_primitives::v6::PvfPrepKind
   **/
  PolkadotPrimitivesV6PvfPrepKind: {
    _enum: ['Precheck', 'Prepare']
  },
  /**
   * Lookup218: polkadot_primitives::v6::PvfExecKind
   **/
  PolkadotPrimitivesV6PvfExecKind: {
    _enum: ['Backing', 'Approval']
  },
  /**
   * Lookup220: polkadot_runtime_parachains::shared::pallet::Call<T>
   **/
  PolkadotRuntimeParachainsSharedPalletCall: 'Null',
  /**
   * Lookup221: polkadot_runtime_parachains::inclusion::pallet::Call<T>
   **/
  PolkadotRuntimeParachainsInclusionPalletCall: 'Null',
  /**
   * Lookup222: polkadot_runtime_parachains::paras_inherent::pallet::Call<T>
   **/
  ...
  /**
   * Lookup223: polkadot_primitives::v6::InherentData<sp_runtime::generic::header::Header<Number, Hash>>
   **/
  ...
  /**
   * Lookup225: polkadot_primitives::v6::signed::UncheckedSigned<polkadot_primitives::v6::AvailabilityBitfield, polkadot_primitives::v6::AvailabilityBitfield>
   **/
  ...
  /**
   * Lookup228: bitvec::order::Lsb0
   **/
  BitvecOrderLsb0: 'Null',
  /**
   * Lookup230: polkadot_primitives::v6::validator_app::Signature
   **/
  ...
  /**
   * Lookup233: polkadot_primitives::v6::BackedCandidate<primitive_types::H256>
   **/
  ...
  /**
   * Lookup234: polkadot_primitives::v6::CommittedCandidateReceipt<primitive_types::H256>
   **/
  ...
  /**
   * Lookup235: polkadot_primitives::v6::CandidateDescriptor<primitive_types::H256>
   **/
  ...
  /**
   * Lookup236: polkadot_primitives::v6::collator_app::Public
   **/
  PolkadotPrimitivesV6CollatorAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup237: polkadot_primitives::v6::collator_app::Signature
   **/
  PolkadotPrimitivesV6CollatorAppSignature: 'SpCoreSr25519Signature',
  /**
   * Lookup239: polkadot_primitives::v6::CandidateCommitments<N>
   **/
  ...
  /**
   * Lookup248: polkadot_primitives::v6::ValidityAttestation
   **/
  ...
  /**
   * Lookup250: polkadot_primitives::v6::DisputeStatementSet
   **/
  ...
  /**
   * Lookup254: polkadot_primitives::v6::DisputeStatement
   **/
  ...
  /**
   * Lookup255: polkadot_primitives::v6::ValidDisputeStatementKind
   **/
  ...
  /**
   * Lookup256: polkadot_primitives::v6::InvalidDisputeStatementKind
   **/
  PolkadotPrimitivesV6InvalidDisputeStatementKind: {
    _enum: ['Explicit']
  },
  /**
   * Lookup257: polkadot_runtime_parachains::paras::pallet::Call<T>
   **/
  ...
  /**
   * Lookup258: polkadot_primitives::v6::PvfCheckStatement
   **/
  ...
  /**
   * Lookup259: polkadot_runtime_parachains::initializer::pallet::Call<T>
   **/
  ...
  /**
   * Lookup260: polkadot_runtime_parachains::hrmp::pallet::Call<T>
   **/
  ...
  /**
   * Lookup261: polkadot_parachain_primitives::primitives::HrmpChannelId
   **/
  ...
  /**
   * Lookup262: polkadot_runtime_parachains::disputes::pallet::Call<T>
   **/
  PolkadotRuntimeParachainsDisputesPalletCall: {
    _enum: ['force_unfreeze']
  },
  /**
   * Lookup263: polkadot_runtime_parachains::disputes::slashing::pallet::Call<T>
   **/
  ...
  /**
   * Lookup264: polkadot_primitives::v6::slashing::DisputeProof
   **/
  ...
  /**
   * Lookup265: polkadot_primitives::v6::slashing::DisputesTimeSlot
   **/
  ...
  /**
   * Lookup266: polkadot_primitives::v6::slashing::SlashingOffenceKind
   **/
  PolkadotPrimitivesV6SlashingSlashingOffenceKind: {
    _enum: ['ForInvalid', 'AgainstValid']
  },
  /**
   * Lookup267: pallet_message_queue::pallet::Call<T>
   **/
  ...
  /**
   * Lookup268: polkadot_runtime_parachains::inclusion::AggregateMessageOrigin
   **/
  ...
  /**
   * Lookup269: polkadot_runtime_parachains::inclusion::UmpQueueId
   **/
  ...
  /**
   * Lookup270: polkadot_runtime_parachains::assigner_on_demand::pallet::Call<T>
   **/
  ...
  /**
   * Lookup271: polkadot_runtime_common::paras_registrar::pallet::Call<T>
   **/
  ...
  /**
   * Lookup272: polkadot_runtime_common::slots::pallet::Call<T>
   **/
  ...
  /**
   * Lookup273: polkadot_runtime_common::auctions::pallet::Call<T>
   **/
  ...
  /**
   * Lookup275: polkadot_runtime_common::crowdloan::pallet::Call<T>
   **/
  ...
  /**
   * Lookup277: sp_runtime::MultiSigner
   **/
  ...
  /**
   * Lookup279: sp_runtime::MultiSignature
   **/
  ...
  /**
   * Lookup282: xcm::v2::Xcm<RuntimeCall>
   **/
  XcmV2Xcm: 'Vec<XcmV2Instruction>',
  /**
   * Lookup284: xcm::v2::Instruction<RuntimeCall>
   **/
  XcmV2Instruction: {
    _enum: {
  ...
  /**
   * Lookup285: xcm::v2::multiasset::MultiAssets
   **/
  XcmV2MultiassetMultiAssets: 'Vec<XcmV2MultiAsset>',
  /**
   * Lookup287: xcm::v2::multiasset::MultiAsset
   **/
  XcmV2MultiAsset: {
  ...
  /**
   * Lookup288: xcm::v2::multiasset::AssetId
   **/
  ...
  /**
   * Lookup289: xcm::v2::multiasset::Fungibility
   **/
  ...
  /**
   * Lookup290: xcm::v2::multiasset::AssetInstance
   **/
  ...
  /**
   * Lookup295: xcm::v2::OriginKind
   **/
  XcmV2OriginKind: {
    _enum: ['Native', 'SovereignAccount', 'Superuser', 'Xcm']
  },
  /**
   * Lookup296: xcm::double_encoded::DoubleEncoded<T>
   **/
  XcmDoubleEncoded: {
    encoded: 'Bytes'
  },
  /**
   * Lookup297: xcm::v2::multiasset::MultiAssetFilter
   **/
  ...
  /**
   * Lookup298: xcm::v2::multiasset::WildMultiAsset
   **/
  ...
  /**
   * Lookup299: xcm::v2::multiasset::WildFungibility
   **/
  XcmV2MultiassetWildFungibility: {
    _enum: ['Fungible', 'NonFungible']
  },
  /**
   * Lookup300: xcm::v2::WeightLimit
   **/
  XcmV2WeightLimit: {
    _enum: {
      Unlimited: 'Null',
  ...
  /**
   * Lookup301: xcm::v3::Xcm<Call>
   **/
  XcmV3Xcm: 'Vec<XcmV3Instruction>',
  /**
   * Lookup303: xcm::v3::Instruction<Call>
   **/
  XcmV3Instruction: {
    _enum: {
  ...
  /**
   * Lookup304: xcm::v3::multiasset::MultiAssets
   **/
  XcmV3MultiassetMultiAssets: 'Vec<XcmV3MultiAsset>',
  /**
   * Lookup306: xcm::v3::multiasset::MultiAsset
   **/
  XcmV3MultiAsset: {
  ...
  /**
   * Lookup307: xcm::v3::multiasset::Fungibility
   **/
  ...
  /**
   * Lookup308: xcm::v3::multiasset::AssetInstance
   **/
  ...
  /**
   * Lookup317: xcm::v3::MaybeErrorCode
   **/
  XcmV3MaybeErrorCode: {
    _enum: {
      Success: 'Null',
  ...
  /**
   * Lookup320: xcm::v3::QueryResponseInfo
   **/
  ...
  /**
   * Lookup321: xcm::v3::multiasset::MultiAssetFilter
   **/
  ...
  /**
   * Lookup322: xcm::v3::multiasset::WildMultiAsset
   **/
  ...
  /**
   * Lookup323: xcm::v3::multiasset::WildFungibility
   **/
  XcmV3MultiassetWildFungibility: {
    _enum: ['Fungible', 'NonFungible']
  },
  /**
   * Lookup324: xcm::v3::WeightLimit
   **/
  XcmV3WeightLimit: {
    _enum: {
      Unlimited: 'Null',
  ...
  /**
   * Lookup325: xcm::VersionedMultiAssets
   **/
  ...
  /**
   * Lookup334: polkadot_runtime_common::identity_migrator::pallet::Call<T>
   **/
  ...
  /**
   * Lookup335: polkadot_runtime_common::paras_sudo_wrapper::pallet::Call<T>
   **/
  ...
  /**
   * Lookup336: polkadot_runtime_parachains::paras::ParaGenesisArgs
   **/
  ...
  /**
   * Lookup337: polkadot_runtime_common::assigned_slots::pallet::Call<T>
   **/
  ...
  /**
   * Lookup338: polkadot_runtime_common::assigned_slots::SlotLeasePeriodStart
   **/
  PolkadotRuntimeCommonAssignedSlotsSlotLeasePeriodStart: {
    _enum: ['Current', 'Next']
  },
  /**
   * Lookup339: rococo_runtime::validator_manager::pallet::Call<T>
   **/
  ...
  /**
   * Lookup340: pallet_state_trie_migration::pallet::Call<T>
   **/
  ...
  /**
   * Lookup342: pallet_state_trie_migration::pallet::MigrationLimits
   **/
  ...
  /**
   * Lookup343: pallet_state_trie_migration::pallet::MigrationTask<T>
   **/
  ...
  /**
   * Lookup344: pallet_state_trie_migration::pallet::Progress<MaxKeyLen>
   **/
  ...
  /**
   * Lookup346: pallet_root_testing::pallet::Call<T>
   **/
  ...
  /**
   * Lookup350: pallet_conviction_voting::types::Tally<Votes, Total>
   **/
  ...
  /**
   * Lookup351: pallet_ranked_collective::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup352: pallet_ranked_collective::VoteRecord
   **/
  ...
  /**
   * Lookup353: pallet_ranked_collective::Tally<T, I, M>
   **/
  ...
  /**
   * Lookup355: pallet_whitelist::pallet::Event<T>
   **/
  ...
  /**
   * Lookup357: frame_support::dispatch::PostDispatchInfo
   **/
  ...
  /**
   * Lookup359: sp_runtime::DispatchErrorWithPostInfo<frame_support::dispatch::PostDispatchInfo>
   **/
  ...
  /**
   * Lookup360: polkadot_runtime_common::claims::pallet::Event<T>
   **/
  ...
  /**
   * Lookup361: pallet_utility::pallet::Event
   **/
  PalletUtilityEvent: {
    _enum: {
      BatchInterrupted: {
  ...
  /**
   * Lookup363: pallet_identity::pallet::Event<T>
   **/
  PalletIdentityEvent: {
    _enum: {
      IdentitySet: {
  ...
  /**
   * Lookup364: pallet_society::pallet::Event<T, I>
   **/
  PalletSocietyEvent: {
    _enum: {
      Founded: {
  ...
  /**
   * Lookup365: pallet_society::GroupParams<Balance>
   **/
  ...
  /**
   * Lookup366: pallet_recovery::pallet::Event<T>
   **/
  PalletRecoveryEvent: {
    _enum: {
      RecoveryCreated: {
  ...
  /**
   * Lookup367: pallet_vesting::pallet::Event<T>
   **/
  PalletVestingEvent: {
    _enum: {
      VestingUpdated: {
  ...
  /**
   * Lookup370: pallet_proxy::pallet::Event<T>
   **/
  PalletProxyEvent: {
    _enum: {
      ProxyExecuted: {
  ...
  /**
   * Lookup371: pallet_multisig::pallet::Event<T>
   **/
  PalletMultisigEvent: {
    _enum: {
      NewMultisig: {
  ...
  /**
   * Lookup372: pallet_preimage::pallet::Event<T>
   **/
  PalletPreimageEvent: {
    _enum: {
      Noted: {
  ...
  /**
   * Lookup373: pallet_asset_rate::pallet::Event<T>
   **/
  ...
  /**
   * Lookup374: pallet_bounties::pallet::Event<T, I>
   **/
  PalletBountiesEvent: {
    _enum: {
      BountyProposed: {
  ...
  /**
   * Lookup375: pallet_child_bounties::pallet::Event<T>
   **/
  ...
  /**
   * Lookup376: pallet_nis::pallet::Event<T>
   **/
  PalletNisEvent: {
    _enum: {
      BidPlaced: {
  ...
  /**
   * Lookup378: polkadot_runtime_parachains::inclusion::pallet::Event<T>
   **/
  ...
  /**
   * Lookup379: polkadot_primitives::v6::CandidateReceipt<primitive_types::H256>
   **/
  ...
  /**
   * Lookup382: polkadot_runtime_parachains::paras::pallet::Event
   **/
  ...
  /**
   * Lookup383: polkadot_runtime_parachains::hrmp::pallet::Event<T>
   **/
  ...
  /**
   * Lookup384: polkadot_runtime_parachains::disputes::pallet::Event<T>
   **/
  ...
  /**
   * Lookup385: polkadot_runtime_parachains::disputes::DisputeLocation
   **/
  PolkadotRuntimeParachainsDisputesDisputeLocation: {
    _enum: ['Local', 'Remote']
  },
  /**
   * Lookup386: polkadot_runtime_parachains::disputes::DisputeResult
   **/
  PolkadotRuntimeParachainsDisputesDisputeResult: {
    _enum: ['Valid', 'Invalid']
  },
  /**
   * Lookup387: pallet_message_queue::pallet::Event<T>
   **/
  ...
  /**
   * Lookup388: frame_support::traits::messages::ProcessMessageError
   **/
  ...
  /**
   * Lookup389: polkadot_runtime_parachains::assigner_on_demand::pallet::Event<T>
   **/
  ...
  /**
   * Lookup390: polkadot_runtime_common::paras_registrar::pallet::Event<T>
   **/
  ...
  /**
   * Lookup391: polkadot_runtime_common::slots::pallet::Event<T>
   **/
  ...
  /**
   * Lookup392: polkadot_runtime_common::auctions::pallet::Event<T>
   **/
  ...
  /**
   * Lookup393: polkadot_runtime_common::crowdloan::pallet::Event<T>
   **/
  ...
  /**
   * Lookup394: pallet_xcm::pallet::Event<T>
   **/
  PalletXcmEvent: {
    _enum: {
      Attempted: {
  ...
  /**
   * Lookup395: xcm::v3::traits::Outcome
   **/
  XcmV3TraitsOutcome: {
    _enum: {
  ...
  /**
   * Lookup396: polkadot_runtime_common::identity_migrator::pallet::Event<T>
   **/
  ...
  /**
   * Lookup397: polkadot_runtime_common::assigned_slots::pallet::Event<T>
   **/
  ...
  /**
   * Lookup398: rococo_runtime::validator_manager::pallet::Event<T>
   **/
  ...
  /**
   * Lookup399: pallet_state_trie_migration::pallet::Event<T>
   **/
  ...
  /**
   * Lookup400: pallet_state_trie_migration::pallet::MigrationCompute
   **/
  PalletStateTrieMigrationMigrationCompute: {
    _enum: ['Signed', 'Auto']
  },
  /**
   * Lookup401: pallet_state_trie_migration::pallet::Error<T>
   **/
  PalletStateTrieMigrationError: {
    _enum: ['MaxSignedLimits', 'KeyTooLong', 'NotEnoughFunds', 'BadWitness', 'SignedMigrationNotAllowed', 'BadChildRoot']
  },
  /**
   * Lookup402: pallet_root_testing::pallet::Event<T>
   **/
  PalletRootTestingEvent: {
    _enum: ['DefensiveTestCall']
  },
  /**
   * Lookup403: pallet_sudo::pallet::Event<T>
   **/
  PalletSudoEvent: {
    _enum: {
      Sudid: {
  ...
  /**
   * Lookup406: frame_system::LastRuntimeUpgradeInfo
   **/
  ...
  /**
   * Lookup408: frame_system::limits::BlockWeights
   **/
  ...
  /**
   * Lookup409: frame_support::dispatch::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup410: frame_system::limits::WeightsPerClass
   **/
  ...
  /**
   * Lookup411: frame_system::limits::BlockLength
   **/
  FrameSystemLimitsBlockLength: {
    max: 'FrameSupportDispatchPerDispatchClassU32'
  },
  /**
   * Lookup412: frame_support::dispatch::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup413: sp_weights::RuntimeDbWeight
   **/
  ...
  /**
   * Lookup414: sp_version::RuntimeVersion
   **/
  ...
  /**
   * Lookup418: frame_system::pallet::Error<T>
   **/
  FrameSystemError: {
    _enum: ['InvalidSpecName', 'SpecVersionNeedsToIncrease', 'FailedToExtractRuntimeVersion', 'NonDefaultComposite', 'NonZeroRefCount', 'CallFiltered']
  },
  /**
   * Lookup425: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup426: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup427: sp_core::sr25519::vrf::VrfSignature
   **/
  ...
  /**
   * Lookup428: sp_consensus_babe::digests::SecondaryPlainPreDigest
   **/
  ...
  /**
   * Lookup429: sp_consensus_babe::digests::SecondaryVRFPreDigest
   **/
  ...
  /**
   * Lookup430: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup436: pallet_indices::pallet::Error<T>
   **/
  PalletIndicesError: {
  ...
  /**
   * Lookup446: rococo_runtime::RuntimeHoldReason
   **/
  ...
  /**
   * Lookup447: pallet_preimage::pallet::HoldReason
   **/
  PalletPreimageHoldReason: {
    _enum: ['Preimage']
  },
  /**
   * Lookup448: pallet_nis::pallet::HoldReason
   **/
  PalletNisHoldReason: {
    _enum: ['NftReceipt']
  },
  /**
   * Lookup451: pallet_balances::types::IdAmount<Id, Balance>
   **/
  ...
  /**
   * Lookup454: pallet_transaction_payment::Releases
   **/
  PalletTransactionPaymentReleases: {
    _enum: ['V1Ancient', 'V2']
  },
  /**
   * Lookup455: sp_staking::offence::OffenceDetails<sp_core::crypto::AccountId32, Offender>
   **/
  ...
  /**
   * Lookup460: pallet_beefy::pallet::Error<T>
   **/
  PalletBeefyError: {
    _enum: ['InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport', 'InvalidConfiguration']
  },
  /**
   * Lookup461: sp_consensus_beefy::mmr::BeefyAuthoritySet<primitive_types::H256>
   **/
  ...
  /**
   * Lookup472: pallet_treasury::Proposal<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup474: pallet_treasury::SpendStatus<polkadot_runtime_common::impls::VersionedLocatableAsset, AssetBalance, xcm::VersionedMultiLocation, BlockNumber, PaymentId>
   **/
  ...
  /**
   * Lookup475: pallet_treasury::PaymentState<Id>
   **/
  ...
  /**
   * Lookup481: pallet_conviction_voting::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber, PollIndex, MaxVotes>
   **/
  ...
  /**
   * Lookup482: pallet_conviction_voting::vote::Casting<Balance, BlockNumber, PollIndex, MaxVotes>
   **/
  ...
  /**
   * Lookup486: pallet_conviction_voting::types::Delegations<Balance>
   **/
  ...
  /**
   * Lookup487: pallet_conviction_voting::vote::PriorLock<BlockNumber, Balance>
   **/
  PalletConvictionVotingVotePriorLock: '(u32,u128)',
  /**
   * Lookup488: pallet_conviction_voting::vote::Delegating<Balance, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup492: pallet_conviction_voting::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup493: pallet_referenda::types::ReferendumInfo<TrackId, rococo_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup494: pallet_referenda::types::ReferendumStatus<TrackId, rococo_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup495: pallet_referenda::types::Deposit<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup498: pallet_referenda::types::DecidingStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup506: pallet_referenda::types::TrackInfo<Balance, Moment>
   **/
  ...
  /**
   * Lookup507: pallet_referenda::types::Curve
   **/
  ...
  /**
   * Lookup510: pallet_referenda::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup511: pallet_ranked_collective::MemberRecord
   **/
  PalletRankedCollectiveMemberRecord: {
    rank: 'u16'
  },
  /**
   * Lookup516: pallet_ranked_collective::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup517: pallet_referenda::types::ReferendumInfo<TrackId, rococo_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_ranked_collective::Tally<T, I, M>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup518: pallet_referenda::types::ReferendumStatus<TrackId, rococo_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_ranked_collective::Tally<T, I, M>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup524: pallet_identity::types::Registration<Balance, MaxJudgements, pallet_identity::legacy::IdentityInfo<FieldLimit>>
   **/
  ...
  /**
   * Lookup532: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32, IdField>
   **/
  ...
  /**
   * Lookup534: pallet_identity::pallet::Error<T>
   **/
  PalletIdentityError: {
  ...
  /**
   * Lookup535: pallet_society::MemberRecord
   **/
  ...
  /**
   * Lookup537: pallet_society::VouchingStatus
   **/
  PalletSocietyVouchingStatus: {
    _enum: ['Vouching', 'Banned']
  },
  /**
   * Lookup538: pallet_society::PayoutRecord<Balance, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup541: pallet_society::Bid<sp_core::crypto::AccountId32, Balance>
   **/
  PalletSocietyBid: {
    who: 'AccountId32',
  ...
  /**
   * Lookup542: pallet_society::BidKind<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup544: pallet_society::Candidacy<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup545: pallet_society::Tally
   **/
  PalletSocietyTally: {
    approvals: 'u32',
    rejections: 'u32'
  ...
  /**
   * Lookup549: pallet_society::IntakeRecord<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup551: pallet_society::pallet::Error<T, I>
   **/
  PalletSocietyError: {
  ...
  /**
   * Lookup552: pallet_recovery::RecoveryConfig<BlockNumber, Balance, bounded_collections::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup554: pallet_recovery::ActiveRecovery<BlockNumber, Balance, bounded_collections::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup555: pallet_recovery::pallet::Error<T>
   **/
  PalletRecoveryError: {
  ...
  /**
   * Lookup558: pallet_vesting::Releases
   **/
  PalletVestingReleases: {
    _enum: ['V0', 'V1']
  },
  /**
   * Lookup559: pallet_vesting::pallet::Error<T>
   **/
  PalletVestingError: {
    _enum: ['NotVesting', 'AtMaxVestingSchedules', 'AmountLow', 'ScheduleIndexOutOfBounds', 'InvalidScheduleParams']
  },
  /**
   * Lookup562: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, BlockNumber, rococo_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup564: pallet_scheduler::pallet::Error<T>
   **/
  PalletSchedulerError: {
    _enum: ['FailedToSchedule', 'NotFound', 'TargetBlockNumberInPast', 'RescheduleNoChange', 'Named']
  },
  /**
   * Lookup567: pallet_proxy::ProxyDefinition<sp_core::crypto::AccountId32, rococo_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup571: pallet_proxy::Announcement<sp_core::crypto::AccountId32, primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup573: pallet_proxy::pallet::Error<T>
   **/
  PalletProxyError: {
    _enum: ['TooMany', 'NotFound', 'NotProxy', 'Unproxyable', 'Duplicate', 'NoPermission', 'Unannounced', 'NoSelfProxy']
  },
  /**
   * Lookup575: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32, MaxApprovals>
   **/
  ...
  /**
   * Lookup577: pallet_multisig::pallet::Error<T>
   **/
  PalletMultisigError: {
    _enum: ['MinimumThreshold', 'AlreadyApproved', 'NoApprovalsNeeded', 'TooFewSignatories', 'TooManySignatories', 'SignatoriesOutOfOrder', 'SenderInSignatories', 'NotFound', 'NotOwner', 'NoTimepoint', 'WrongTimepoint', 'UnexpectedTimepoint', 'MaxWeightTooLow', 'AlreadyStored']
  },
  /**
   * Lookup578: pallet_preimage::OldRequestStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup581: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32, frame_support::traits::tokens::fungible::HoldConsideration<A, F, R, D>>
   **/
  ...
  /**
   * Lookup593: pallet_child_bounties::ChildBounty<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup594: pallet_child_bounties::ChildBountyStatus<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup595: pallet_child_bounties::pallet::Error<T>
   **/
  PalletChildBountiesError: {
    _enum: ['ParentBountyNotActive', 'InsufficientBountyBalance', 'TooManyChildBounties']
  },
  /**
   * Lookup598: pallet_nis::pallet::Bid<Balance, sp_core::crypto::AccountId32>
   **/
  PalletNisBid: {
    amount: 'u128',
    who: 'AccountId32'
  ...
  /**
   * Lookup600: pallet_nis::pallet::SummaryRecord<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup601: pallet_nis::pallet::ReceiptRecord<sp_core::crypto::AccountId32, BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup603: pallet_nis::pallet::Error<T>
   **/
  PalletNisError: {
  ...
  /**
   * Lookup610: polkadot_runtime_parachains::configuration::pallet::Error<T>
   **/
  PolkadotRuntimeParachainsConfigurationPalletError: {
    _enum: ['InvalidNewValue']
  },
  /**
   * Lookup613: polkadot_runtime_parachains::shared::AllowedRelayParentsTracker<primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup616: polkadot_runtime_parachains::inclusion::AvailabilityBitfieldRecord<N>
   **/
  ...
  /**
   * Lookup617: polkadot_runtime_parachains::inclusion::CandidatePendingAvailability<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup618: polkadot_runtime_parachains::inclusion::pallet::Error<T>
   **/
  ...
  /**
   * Lookup619: polkadot_primitives::v6::ScrapedOnChainVotes<primitive_types::H256>
   **/
  ...
  /**
   * Lookup624: polkadot_runtime_parachains::paras_inherent::pallet::Error<T>
   **/
  ...
  /**
   * Lookup627: polkadot_runtime_parachains::scheduler::pallet::CoreOccupied<N>
   **/
  ...
  /**
   * Lookup628: polkadot_runtime_parachains::scheduler::pallet::ParasEntry<N>
   **/
  ...
  /**
   * Lookup629: polkadot_runtime_parachains::scheduler::common::Assignment
   **/
  PolkadotRuntimeParachainsSchedulerCommonAssignment: {
    paraId: 'u32'
  },
  /**
   * Lookup635: polkadot_runtime_parachains::paras::PvfCheckActiveVoteState<BlockNumber>
   **/
  ...
  /**
   * Lookup637: polkadot_runtime_parachains::paras::PvfCheckCause<BlockNumber>
   **/
  ...
  /**
   * Lookup638: polkadot_runtime_parachains::paras::SetGoAhead
   **/
  PolkadotRuntimeParachainsParasSetGoAhead: {
    _enum: ['Yes', 'No']
  },
  /**
   * Lookup641: polkadot_runtime_parachains::paras::ParaLifecycle
   **/
  ...
  /**
   * Lookup643: polkadot_runtime_parachains::paras::ParaPastCodeMeta<N>
   **/
  ...
  /**
   * Lookup645: polkadot_runtime_parachains::paras::ReplacementTimes<N>
   **/
  ...
  /**
   * Lookup647: polkadot_primitives::v6::UpgradeGoAhead
   **/
  PolkadotPrimitivesV6UpgradeGoAhead: {
    _enum: ['Abort', 'GoAhead']
  },
  /**
   * Lookup648: polkadot_primitives::v6::UpgradeRestriction
   **/
  PolkadotPrimitivesV6UpgradeRestriction: {
    _enum: ['Present']
  },
  /**
   * Lookup649: polkadot_runtime_parachains::paras::pallet::Error<T>
   **/
  ...
  /**
   * Lookup651: polkadot_runtime_parachains::initializer::BufferedSessionChange
   **/
  ...
  /**
   * Lookup653: polkadot_core_primitives::InboundDownwardMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup654: polkadot_runtime_parachains::hrmp::HrmpOpenChannelRequest
   **/
  ...
  /**
   * Lookup656: polkadot_runtime_parachains::hrmp::HrmpChannel
   **/
  ...
  /**
   * Lookup658: polkadot_core_primitives::InboundHrmpMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup661: polkadot_runtime_parachains::hrmp::pallet::Error<T>
   **/
  ...
  /**
   * Lookup663: polkadot_primitives::v6::SessionInfo
   **/
  ...
  /**
   * Lookup664: polkadot_primitives::v6::IndexedVec<polkadot_primitives::v6::ValidatorIndex, polkadot_primitives::v6::validator_app::Public>
   **/
  PolkadotPrimitivesV6IndexedVecValidatorIndex: 'Vec<PolkadotPrimitivesV6ValidatorAppPublic>',
  /**
   * Lookup666: polkadot_primitives::v6::IndexedVec<polkadot_primitives::v6::GroupIndex, V>
   **/
  PolkadotPrimitivesV6IndexedVecGroupIndex: 'Vec<Vec<u32>>',
  /**
   * Lookup668: polkadot_primitives::v6::DisputeState<N>
   **/
  ...
  /**
   * Lookup670: polkadot_runtime_parachains::disputes::pallet::Error<T>
   **/
  ...
  /**
   * Lookup671: polkadot_primitives::v6::slashing::PendingSlashes
   **/
  ...
  /**
   * Lookup675: polkadot_runtime_parachains::disputes::slashing::pallet::Error<T>
   **/
  ...
  /**
   * Lookup676: pallet_message_queue::BookState<polkadot_runtime_parachains::inclusion::AggregateMessageOrigin>
   **/
  ...
  /**
   * Lookup678: pallet_message_queue::Neighbours<polkadot_runtime_parachains::inclusion::AggregateMessageOrigin>
   **/
  ...
  /**
   * Lookup684: polkadot_runtime_parachains::assigner_on_demand::CoreAffinityCount
   **/
  ...
  /**
   * Lookup685: polkadot_runtime_parachains::assigner_on_demand::pallet::Error<T>
   **/
  ...
  /**
   * Lookup686: polkadot_runtime_common::paras_registrar::ParaInfo<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup688: polkadot_runtime_common::paras_registrar::pallet::Error<T>
   **/
  ...
  /**
   * Lookup690: polkadot_runtime_common::slots::pallet::Error<T>
   **/
  PolkadotRuntimeCommonSlotsPalletError: {
    _enum: ['ParaNotOnboarding', 'LeaseError']
  },
  /**
   * Lookup695: polkadot_runtime_common::auctions::pallet::Error<T>
   **/
  ...
  /**
   * Lookup696: polkadot_runtime_common::crowdloan::FundInfo<sp_core::crypto::AccountId32, Balance, BlockNumber, LeasePeriod>
   **/
  ...
  /**
   * Lookup697: polkadot_runtime_common::crowdloan::LastContribution<BlockNumber>
   **/
  ...
  /**
   * Lookup698: polkadot_runtime_common::crowdloan::pallet::Error<T>
   **/
  ...
  /**
   * Lookup699: pallet_xcm::pallet::QueryStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup703: xcm::VersionedResponse
   **/
  ...
  /**
   * Lookup709: pallet_xcm::pallet::VersionMigrationStage
   **/
  ...
  /**
   * Lookup712: xcm::VersionedAssetId
   **/
  XcmVersionedAssetId: {
    _enum: {
      __Unused0: 'Null',
  ...
  /**
   * Lookup713: pallet_xcm::pallet::RemoteLockedFungibleRecord<ConsumerIdentifier, MaxConsumers>
   **/
  ...
  /**
   * Lookup720: pallet_xcm::pallet::Error<T>
   **/
  PalletXcmError: {
  ...
  /**
   * Lookup721: polkadot_runtime_common::paras_sudo_wrapper::pallet::Error<T>
   **/
  ...
  /**
   * Lookup722: polkadot_runtime_common::assigned_slots::ParachainTemporarySlot<sp_core::crypto::AccountId32, LeasePeriod>
   **/
  ...
  /**
   * Lookup723: polkadot_runtime_common::assigned_slots::pallet::Error<T>
   **/
  ...
  /**
   * Lookup724: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  ...
  /**
   * Lookup736: rococo_runtime::Runtime
   **/
