...
export default {
  ...
  /**
   * Lookup19: frame_system::EventRecord<contracts_node_runtime::RuntimeEvent, primitive_types::H256>
   **/
  ...
  /**
   * Lookup38: pallet_contracts::pallet::Event<T>
   **/
  ...
  /**
   * Lookup39: pallet_contracts::Origin<contracts_node_runtime::Runtime>
   **/
  ...
  /**
   * Lookup40: contracts_node_runtime::Runtime
   **/
  ...
  /**
   * Lookup69: pallet_utility::pallet::Call<T>
   **/
  PalletUtilityCall: {
    _enum: {
      batch: {
      ...
      dispatch_as: {
        asOrigin: 'ContractsNodeRuntimeOriginCaller',
        call: 'Call',
      },
      force_batch: {
        calls: 'Vec<Call>',
  ...
  /**
   * Lookup73: pallet_balances::pallet::Call<T, I>
   **/
  PalletBalancesCall: {
    _enum: {
  ...
  /**
   * Lookup80: pallet_contracts::pallet::Call<T>
   **/
  PalletContractsCall: {
    _enum: {
      call_old_weight: {
  ...
  /**
   * Lookup82: pallet_contracts::wasm::Determinism
   **/
  PalletContractsWasmDeterminism: {
    _enum: ['Enforced', 'Relaxed']
  },
  /**
   * Lookup83: pallet_assets::pallet::Call<T, I>
   **/
  PalletAssetsCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup84: contracts_node_runtime::OriginCaller
   **/
  ContractsNodeRuntimeOriginCaller: {
    _enum: {
  ...
  /**
   * Lookup86: sp_core::Void
   **/
  SpCoreVoid: 'Null',
  /**
   * Lookup87: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls']
  },
  /**
   * Lookup89: pallet_balances::types::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup90: pallet_balances::types::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup93: pallet_balances::types::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup97: contracts_node_runtime::RuntimeHoldReason
   **/
  ContractsNodeRuntimeRuntimeHoldReason: {
    _enum: {
      __Unused0: 'Null',
      __Unused1: 'Null',
      __Unused2: 'Null',
  ...
  /**
   * Lookup98: pallet_contracts::pallet::HoldReason
   **/
  ...
  /**
   * Lookup108: pallet_contracts::wasm::CodeInfo<T>
   **/
  ...
  /**
   * Lookup109: pallet_contracts::storage::ContractInfo<T>
   **/
  ...
  /**
   * Lookup115: pallet_contracts::storage::DeletionQueueManager<T>
   **/
  ...
  /**
   * Lookup117: pallet_contracts::schedule::Schedule<T>
   **/
  ...
  /**
   * Lookup118: pallet_contracts::schedule::Limits
   **/
  ...
  /**
   * Lookup119: pallet_contracts::schedule::InstructionWeights<T>
   **/
  PalletContractsScheduleInstructionWeights: {
    base: 'u32'
  },
  /**
   * Lookup120: pallet_contracts::schedule::HostFnWeights<T>
   **/
  ...
  /**
   * Lookup122: pallet_contracts::Environment<T>
   **/
  ...
  /**
   * Lookup123: pallet_contracts::EnvironmentType<sp_core::crypto::AccountId32>
   **/
  PalletContractsEnvironmentTypeAccountId32: 'Null',
  /**
   * Lookup124: pallet_contracts::EnvironmentType<T>
   **/
  PalletContractsEnvironmentTypeU128: 'Null',
  /**
   * Lookup125: pallet_contracts::EnvironmentType<primitive_types::H256>
   **/
  PalletContractsEnvironmentTypeH256: 'Null',
  /**
   * Lookup126: pallet_contracts::EnvironmentType<sp_runtime::traits::BlakeTwo256>
   **/
  ...
  /**
   * Lookup128: pallet_contracts::EnvironmentType<T>
   **/
  PalletContractsEnvironmentTypeU64: 'Null',
  /**
   * Lookup129: pallet_contracts::EnvironmentType<T>
   **/
  PalletContractsEnvironmentTypeU32: 'Null',
  /**
   * Lookup130: pallet_contracts::pallet::Error<T>
   **/
  ...
  /**
   * Lookup131: pallet_assets::types::AssetDetails<Balance, sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup132: pallet_assets::types::AssetStatus
   **/
  PalletAssetsAssetStatus: {
    _enum: ['Live', 'Frozen', 'Destroying']
  },
  /**
   * Lookup134: pallet_assets::types::AssetAccount<Balance, DepositBalance, Extra, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup135: pallet_assets::types::AccountStatus
   **/
  PalletAssetsAccountStatus: {
    _enum: ['Liquid', 'Frozen', 'Blocked']
  },
  /**
   * Lookup136: pallet_assets::types::ExistenceReason<Balance, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup138: pallet_assets::types::Approval<Balance, DepositBalance>
   **/
  ...
  /**
   * Lookup139: pallet_assets::types::AssetMetadata<DepositBalance, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup141: pallet_assets::pallet::Error<T, I>
   **/
  PalletAssetsError: {
  ...
  /**
   * Lookup143: sp_runtime::MultiSignature
   **/
  ...
  /**
   * Lookup146: sp_core::sr25519::Signature
   **/
  SpCoreSr25519Signature: '[u8;64]',
  /**
   * Lookup147: sp_core::ecdsa::Signature
   **/
  SpCoreEcdsaSignature: '[u8;65]',
  /**
   * Lookup150: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T>
   **/
