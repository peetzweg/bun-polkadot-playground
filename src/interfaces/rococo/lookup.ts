...
export default {
  ...
  /**
   * Lookup200: pallet_society::pallet::Call<T, I>
   **/
  PalletSocietyCall: {
    _enum: {
      bid: {
  ...
  /**
   * Lookup201: pallet_recovery::pallet::Call<T>
   **/
  PalletRecoveryCall: {
    _enum: {
      as_recovered: {
  ...
  /**
   * Lookup212: pallet_multisig::Timepoint<BlockNumber>
   **/
  ...
  /**
   * Lookup215: pallet_asset_rate::pallet::Call<T>
   **/
  PalletAssetRateCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup218: pallet_child_bounties::pallet::Call<T>
   **/
  ...
  /**
   * Lookup219: pallet_nis::pallet::Call<T>
   **/
  PalletNisCall: {
    _enum: {
      place_bid: {
  ...
  /**
   * Lookup223: polkadot_runtime_parachains::configuration::pallet::Call<T>
   **/
  ...
  /**
   * Lookup224: polkadot_primitives::v6::async_backing::AsyncBackingParams
   **/
  ...
  /**
   * Lookup225: polkadot_primitives::v6::executor_params::ExecutorParams
   **/
  PolkadotPrimitivesV6ExecutorParams: 'Vec<PolkadotPrimitivesV6ExecutorParamsExecutorParam>',
  /**
   * Lookup227: polkadot_primitives::v6::executor_params::ExecutorParam
   **/
  ...
  /**
   * Lookup228: polkadot_primitives::v6::PvfPrepKind
   **/
  PolkadotPrimitivesV6PvfPrepKind: {
    _enum: ['Precheck', 'Prepare']
  },
  /**
   * Lookup229: polkadot_primitives::v6::PvfExecKind
   **/
  PolkadotPrimitivesV6PvfExecKind: {
    _enum: ['Backing', 'Approval']
  },
  /**
   * Lookup231: polkadot_runtime_parachains::shared::pallet::Call<T>
   **/
  PolkadotRuntimeParachainsSharedPalletCall: 'Null',
  /**
   * Lookup232: polkadot_runtime_parachains::inclusion::pallet::Call<T>
   **/
  PolkadotRuntimeParachainsInclusionPalletCall: 'Null',
  /**
   * Lookup233: polkadot_runtime_parachains::paras_inherent::pallet::Call<T>
   **/
  ...
  /**
   * Lookup234: polkadot_primitives::v6::InherentData<sp_runtime::generic::header::Header<Number, Hash>>
   **/
  ...
  /**
   * Lookup236: polkadot_primitives::v6::signed::UncheckedSigned<polkadot_primitives::v6::AvailabilityBitfield, polkadot_primitives::v6::AvailabilityBitfield>
   **/
  ...
  /**
   * Lookup239: bitvec::order::Lsb0
   **/
  BitvecOrderLsb0: 'Null',
  /**
   * Lookup241: polkadot_primitives::v6::validator_app::Signature
   **/
  PolkadotPrimitivesV6ValidatorAppSignature: 'SpCoreSr25519Signature',
  /**
   * Lookup243: polkadot_primitives::v6::BackedCandidate<primitive_types::H256>
   **/
  ...
  /**
   * Lookup244: polkadot_primitives::v6::CommittedCandidateReceipt<primitive_types::H256>
   **/
  ...
  /**
   * Lookup245: polkadot_primitives::v6::CandidateDescriptor<primitive_types::H256>
   **/
  ...
  /**
   * Lookup246: polkadot_primitives::v6::collator_app::Public
   **/
  PolkadotPrimitivesV6CollatorAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup247: polkadot_primitives::v6::collator_app::Signature
   **/
  PolkadotPrimitivesV6CollatorAppSignature: 'SpCoreSr25519Signature',
  /**
   * Lookup249: polkadot_primitives::v6::CandidateCommitments<N>
   **/
  ...
  /**
   * Lookup258: polkadot_primitives::v6::ValidityAttestation
   **/
  ...
  /**
   * Lookup260: polkadot_primitives::v6::DisputeStatementSet
   **/
  ...
  /**
   * Lookup264: polkadot_primitives::v6::DisputeStatement
   **/
  ...
  /**
   * Lookup265: polkadot_primitives::v6::ValidDisputeStatementKind
   **/
  ...
  /**
   * Lookup266: polkadot_primitives::v6::InvalidDisputeStatementKind
   **/
  PolkadotPrimitivesV6InvalidDisputeStatementKind: {
    _enum: ['Explicit']
  },
  /**
   * Lookup267: polkadot_runtime_parachains::paras::pallet::Call<T>
   **/
  ...
  /**
   * Lookup268: polkadot_primitives::v6::PvfCheckStatement
   **/
  ...
  /**
   * Lookup269: polkadot_runtime_parachains::initializer::pallet::Call<T>
   **/
  ...
  /**
   * Lookup270: polkadot_runtime_parachains::hrmp::pallet::Call<T>
   **/
  ...
  /**
   * Lookup271: polkadot_parachain_primitives::primitives::HrmpChannelId
   **/
  ...
  /**
   * Lookup272: polkadot_runtime_parachains::disputes::pallet::Call<T>
   **/
  PolkadotRuntimeParachainsDisputesPalletCall: {
    _enum: ['force_unfreeze']
  },
  /**
   * Lookup273: polkadot_runtime_parachains::disputes::slashing::pallet::Call<T>
   **/
  ...
  /**
   * Lookup274: polkadot_primitives::v6::slashing::DisputeProof
   **/
  ...
  /**
   * Lookup275: polkadot_primitives::v6::slashing::DisputesTimeSlot
   **/
  ...
  /**
   * Lookup276: polkadot_primitives::v6::slashing::SlashingOffenceKind
   **/
  PolkadotPrimitivesV6SlashingSlashingOffenceKind: {
    _enum: ['ForInvalid', 'AgainstValid']
  },
  /**
   * Lookup277: pallet_message_queue::pallet::Call<T>
   **/
  ...
  /**
   * Lookup278: polkadot_runtime_parachains::inclusion::AggregateMessageOrigin
   **/
  ...
  /**
   * Lookup279: polkadot_runtime_parachains::inclusion::UmpQueueId
   **/
  ...
  /**
   * Lookup280: polkadot_runtime_parachains::assigner_on_demand::pallet::Call<T>
   **/
  ...
  /**
   * Lookup281: polkadot_runtime_common::paras_registrar::pallet::Call<T>
   **/
  ...
  /**
   * Lookup282: polkadot_runtime_common::slots::pallet::Call<T>
   **/
  ...
  /**
   * Lookup283: polkadot_runtime_common::auctions::pallet::Call<T>
   **/
  ...
  /**
   * Lookup285: polkadot_runtime_common::crowdloan::pallet::Call<T>
   **/
  ...
  /**
   * Lookup287: sp_runtime::MultiSigner
   **/
  ...
  /**
   * Lookup288: pallet_xcm::pallet::Call<T>
   **/
  PalletXcmCall: {
    _enum: {
      send: {
  ...
  /**
   * Lookup289: xcm::VersionedXcm<RuntimeCall>
   **/
  XcmVersionedXcm: {
    _enum: {
      __Unused0: 'Null',
  ...
  /**
   * Lookup290: xcm::v2::Xcm<RuntimeCall>
   **/
  XcmV2Xcm: 'Vec<XcmV2Instruction>',
  /**
   * Lookup292: xcm::v2::Instruction<RuntimeCall>
   **/
  XcmV2Instruction: {
    _enum: {
  ...
  /**
   * Lookup293: xcm::v2::multiasset::MultiAssets
   **/
  XcmV2MultiassetMultiAssets: 'Vec<XcmV2MultiAsset>',
  /**
   * Lookup295: xcm::v2::multiasset::MultiAsset
   **/
  XcmV2MultiAsset: {
  ...
  /**
   * Lookup296: xcm::v2::multiasset::AssetId
   **/
  ...
  /**
   * Lookup297: xcm::v2::multiasset::Fungibility
   **/
  ...
  /**
   * Lookup298: xcm::v2::multiasset::AssetInstance
   **/
  ...
  /**
   * Lookup303: xcm::v2::OriginKind
   **/
  XcmV2OriginKind: {
    _enum: ['Native', 'SovereignAccount', 'Superuser', 'Xcm']
  },
  /**
   * Lookup304: xcm::double_encoded::DoubleEncoded<T>
   **/
  XcmDoubleEncoded: {
    encoded: 'Bytes'
  },
  ...
  /**
   * Lookup312: xcm::v3::multiasset::MultiAssets
   **/
  XcmV3MultiassetMultiAssets: 'Vec<XcmV3MultiAsset>',
  /**
   * Lookup314: xcm::v3::multiasset::MultiAsset
   **/
  XcmV3MultiAsset: {
  ...
  /**
   * Lookup315: xcm::v3::multiasset::Fungibility
   **/
  ...
  /**
   * Lookup316: xcm::v3::multiasset::AssetInstance
   **/
  ...
  /**
   * Lookup325: xcm::v3::MaybeErrorCode
   **/
  XcmV3MaybeErrorCode: {
    _enum: {
      Success: 'Null',
  ...
  /**
   * Lookup333: xcm::VersionedMultiAssets
   **/
  ...
  /**
   * Lookup342: polkadot_runtime_common::identity_migrator::pallet::Call<T>
   **/
  ...
  /**
   * Lookup343: polkadot_runtime_common::paras_sudo_wrapper::pallet::Call<T>
   **/
  ...
  /**
   * Lookup344: polkadot_runtime_parachains::paras::ParaGenesisArgs
   **/
  ...
  /**
   * Lookup345: polkadot_runtime_common::assigned_slots::pallet::Call<T>
   **/
  ...
  /**
   * Lookup346: polkadot_runtime_common::assigned_slots::SlotLeasePeriodStart
   **/
  PolkadotRuntimeCommonAssignedSlotsSlotLeasePeriodStart: {
    _enum: ['Current', 'Next']
  },
  /**
   * Lookup347: rococo_runtime::validator_manager::pallet::Call<T>
   **/
  ...
  /**
   * Lookup348: pallet_state_trie_migration::pallet::Call<T>
   **/
  ...
  /**
   * Lookup350: pallet_state_trie_migration::pallet::MigrationLimits
   **/
  ...
  /**
   * Lookup351: pallet_state_trie_migration::pallet::MigrationTask<T>
   **/
  ...
  /**
   * Lookup352: pallet_state_trie_migration::pallet::Progress<MaxKeyLen>
   **/
  ...
  /**
   * Lookup354: pallet_root_testing::pallet::Call<T>
   **/
  ...
  /**
   * Lookup355: pallet_sudo::pallet::Call<T>
   **/
  PalletSudoCall: {
    _enum: {
      sudo: {
  ...
  /**
   * Lookup358: pallet_conviction_voting::types::Tally<Votes, Total>
   **/
  ...
  /**
   * Lookup359: pallet_ranked_collective::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup360: pallet_ranked_collective::VoteRecord
   **/
  ...
  /**
   * Lookup363: pallet_whitelist::pallet::Event<T>
   **/
  ...
  /**
   * Lookup365: frame_support::dispatch::PostDispatchInfo
   **/
  ...
  /**
   * Lookup367: sp_runtime::DispatchErrorWithPostInfo<frame_support::dispatch::PostDispatchInfo>
   **/
  ...
  /**
   * Lookup368: polkadot_runtime_common::claims::pallet::Event<T>
   **/
  ...
  /**
   * Lookup369: pallet_utility::pallet::Event
   **/
  PalletUtilityEvent: {
    _enum: {
      BatchInterrupted: {
  ...
  /**
   * Lookup372: pallet_society::pallet::Event<T, I>
   **/
  PalletSocietyEvent: {
    _enum: {
      Founded: {
  ...
  /**
   * Lookup373: pallet_society::GroupParams<Balance>
   **/
  ...
  /**
   * Lookup374: pallet_recovery::pallet::Event<T>
   **/
  PalletRecoveryEvent: {
    _enum: {
      RecoveryCreated: {
  ...
  /**
   * Lookup375: pallet_vesting::pallet::Event<T>
   **/
  PalletVestingEvent: {
    _enum: {
      VestingUpdated: {
  ...
  /**
   * Lookup376: pallet_scheduler::pallet::Event<T>
   **/
  ...
  /**
   * Lookup378: pallet_proxy::pallet::Event<T>
   **/
  PalletProxyEvent: {
    _enum: {
      ProxyExecuted: {
  ...
  /**
   * Lookup379: pallet_multisig::pallet::Event<T>
   **/
  PalletMultisigEvent: {
    _enum: {
      NewMultisig: {
  ...
  /**
   * Lookup380: pallet_preimage::pallet::Event<T>
   **/
  PalletPreimageEvent: {
    _enum: {
      Noted: {
  ...
  /**
   * Lookup381: pallet_asset_rate::pallet::Event<T>
   **/
  ...
  /**
   * Lookup382: pallet_bounties::pallet::Event<T, I>
   **/
  PalletBountiesEvent: {
    _enum: {
      BountyProposed: {
  ...
  /**
   * Lookup383: pallet_child_bounties::pallet::Event<T>
   **/
  ...
  /**
   * Lookup384: pallet_nis::pallet::Event<T>
   **/
  PalletNisEvent: {
    _enum: {
      BidPlaced: {
  ...
  /**
   * Lookup386: polkadot_runtime_parachains::inclusion::pallet::Event<T>
   **/
  ...
  /**
   * Lookup387: polkadot_primitives::v6::CandidateReceipt<primitive_types::H256>
   **/
  ...
  /**
   * Lookup390: polkadot_runtime_parachains::paras::pallet::Event
   **/
  ...
  /**
   * Lookup391: polkadot_runtime_parachains::hrmp::pallet::Event<T>
   **/
  ...
  /**
   * Lookup392: polkadot_runtime_parachains::disputes::pallet::Event<T>
   **/
  ...
  /**
   * Lookup393: polkadot_runtime_parachains::disputes::DisputeLocation
   **/
  PolkadotRuntimeParachainsDisputesDisputeLocation: {
    _enum: ['Local', 'Remote']
  },
  /**
   * Lookup394: polkadot_runtime_parachains::disputes::DisputeResult
   **/
  ...
  /**
   * Lookup397: polkadot_runtime_parachains::assigner_on_demand::pallet::Event<T>
   **/
  ...
  /**
   * Lookup398: polkadot_runtime_common::paras_registrar::pallet::Event<T>
   **/
  ...
  /**
   * Lookup399: polkadot_runtime_common::slots::pallet::Event<T>
   **/
  ...
  /**
   * Lookup400: polkadot_runtime_common::auctions::pallet::Event<T>
   **/
  ...
  /**
   * Lookup401: polkadot_runtime_common::crowdloan::pallet::Event<T>
   **/
  ...
  /**
   * Lookup402: pallet_xcm::pallet::Event<T>
   **/
  PalletXcmEvent: {
    _enum: {
      Attempted: {
  ...
  /**
   * Lookup403: xcm::v3::traits::Outcome
   **/
  XcmV3TraitsOutcome: {
    _enum: {
  ...
  /**
   * Lookup404: polkadot_runtime_common::identity_migrator::pallet::Event<T>
   **/
  ...
  /**
   * Lookup405: polkadot_runtime_common::assigned_slots::pallet::Event<T>
   **/
  ...
  /**
   * Lookup406: rococo_runtime::validator_manager::pallet::Event<T>
   **/
  ...
  /**
   * Lookup407: pallet_state_trie_migration::pallet::Event<T>
   **/
  ...
  /**
   * Lookup408: pallet_state_trie_migration::pallet::MigrationCompute
   **/
  PalletStateTrieMigrationMigrationCompute: {
    _enum: ['Signed', 'Auto']
  },
  /**
   * Lookup409: pallet_state_trie_migration::pallet::Error<T>
   **/
  PalletStateTrieMigrationError: {
    _enum: ['MaxSignedLimits', 'KeyTooLong', 'NotEnoughFunds', 'BadWitness', 'SignedMigrationNotAllowed', 'BadChildRoot']
  },
  /**
   * Lookup410: pallet_root_testing::pallet::Event<T>
   **/
  PalletRootTestingEvent: {
    _enum: ['DefensiveTestCall']
  },
  /**
   * Lookup411: pallet_sudo::pallet::Event<T>
   **/
  PalletSudoEvent: {
    _enum: {
      Sudid: {
  ...
  /**
   * Lookup414: frame_system::LastRuntimeUpgradeInfo
   **/
  ...
  /**
   * Lookup416: frame_system::limits::BlockWeights
   **/
  ...
  /**
   * Lookup417: frame_support::dispatch::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup418: frame_system::limits::WeightsPerClass
   **/
  ...
  /**
   * Lookup419: frame_system::limits::BlockLength
   **/
  FrameSystemLimitsBlockLength: {
    max: 'FrameSupportDispatchPerDispatchClassU32'
  },
  /**
   * Lookup420: frame_support::dispatch::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup421: sp_weights::RuntimeDbWeight
   **/
  ...
  /**
   * Lookup422: sp_version::RuntimeVersion
   **/
  ...
  /**
   * Lookup426: frame_system::pallet::Error<T>
   **/
  FrameSystemError: {
    _enum: ['InvalidSpecName', 'SpecVersionNeedsToIncrease', 'FailedToExtractRuntimeVersion', 'NonDefaultComposite', 'NonZeroRefCount', 'CallFiltered']
  },
  /**
   * Lookup433: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup434: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup435: sp_core::sr25519::vrf::VrfSignature
   **/
  ...
  /**
   * Lookup438: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup442: pallet_babe::pallet::Error<T>
   **/
  PalletBabeError: {
    _enum: ['InvalidEquivocationProof', 'InvalidKeyOwnershipProof', 'DuplicateOffenceReport', 'InvalidConfiguration']
  },
  /**
   * Lookup444: pallet_indices::pallet::Error<T>
   **/
  PalletIndicesError: {
  ...
  /**
   * Lookup454: rococo_runtime::RuntimeHoldReason
   **/
  ...
  /**
   * Lookup456: pallet_nis::pallet::HoldReason
   **/
  PalletNisHoldReason: {
    _enum: ['NftReceipt']
  },
  /**
   * Lookup459: pallet_balances::types::IdAmount<Id, Balance>
   **/
  ...
  /**
   * Lookup463: sp_staking::offence::OffenceDetails<sp_core::crypto::AccountId32, Offender>
   **/
  ...
  /**
   * Lookup467: pallet_beefy::pallet::Error<T>
   **/
  PalletBeefyError: {
    _enum: ['InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport', 'InvalidConfiguration']
  },
  /**
   * Lookup468: sp_consensus_beefy::mmr::BeefyAuthoritySet<primitive_types::H256>
   **/
  ...
  /**
   * Lookup473: sp_core::crypto::KeyTypeId
   **/
  SpCoreCryptoKeyTypeId: '[u8;4]',
  /**
   * Lookup474: pallet_session::pallet::Error<T>
   **/
  PalletSessionError: {
  ...
  /**
   * Lookup485: pallet_treasury::SpendStatus<polkadot_runtime_common::impls::VersionedLocatableAsset, AssetBalance, xcm::VersionedMultiLocation, BlockNumber, PaymentId>
   **/
  ...
  /**
   * Lookup486: pallet_treasury::PaymentState<Id>
   **/
  ...
  /**
   * Lookup489: frame_support::PalletId
   **/
  ...
  /**
   * Lookup492: pallet_conviction_voting::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber, PollIndex, MaxVotes>
   **/
  ...
  /**
   * Lookup493: pallet_conviction_voting::vote::Casting<Balance, BlockNumber, PollIndex, MaxVotes>
   **/
  ...
  /**
   * Lookup497: pallet_conviction_voting::types::Delegations<Balance>
   **/
  ...
  /**
   * Lookup498: pallet_conviction_voting::vote::PriorLock<BlockNumber, Balance>
   **/
  PalletConvictionVotingVotePriorLock: '(u32,u128)',
  /**
   * Lookup499: pallet_conviction_voting::vote::Delegating<Balance, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup503: pallet_conviction_voting::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup504: pallet_referenda::types::ReferendumInfo<TrackId, rococo_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup505: pallet_referenda::types::ReferendumStatus<TrackId, rococo_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup506: pallet_referenda::types::Deposit<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup509: pallet_referenda::types::DecidingStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup522: pallet_ranked_collective::MemberRecord
   **/
  PalletRankedCollectiveMemberRecord: {
    rank: 'u16'
  },
  /**
   * Lookup526: pallet_ranked_collective::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup527: pallet_referenda::types::ReferendumInfo<TrackId, rococo_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_ranked_collective::Tally<T, I, M>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup528: pallet_referenda::types::ReferendumStatus<TrackId, rococo_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, Balance, pallet_ranked_collective::Tally<T, I, M>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup535: pallet_identity::types::Registration<Balance, MaxJudgements, pallet_identity::legacy::IdentityInfo<FieldLimit>>
   **/
  ...
  /**
   * Lookup544: pallet_identity::types::RegistrarInfo<Balance, sp_core::crypto::AccountId32, IdField>
   **/
  ...
  /**
   * Lookup546: pallet_identity::types::AuthorityProperties<bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup550: pallet_society::MemberRecord
   **/
  ...
  /**
   * Lookup553: pallet_society::PayoutRecord<Balance, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup559: pallet_society::Candidacy<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup560: pallet_society::Tally
   **/
  PalletSocietyTally: {
    approvals: 'u32',
    rejections: 'u32'
  ...
  /**
   * Lookup564: pallet_society::IntakeRecord<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup566: pallet_society::pallet::Error<T, I>
   **/
  PalletSocietyError: {
  ...
  /**
   * Lookup567: pallet_recovery::RecoveryConfig<BlockNumber, Balance, bounded_collections::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup569: pallet_recovery::ActiveRecovery<BlockNumber, Balance, bounded_collections::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup570: pallet_recovery::pallet::Error<T>
   **/
  PalletRecoveryError: {
  ...
  /**
   * Lookup573: pallet_vesting::Releases
   **/
  PalletVestingReleases: {
    _enum: ['V0', 'V1']
  },
  /**
   * Lookup574: pallet_vesting::pallet::Error<T>
   **/
  PalletVestingError: {
    _enum: ['NotVesting', 'AtMaxVestingSchedules', 'AmountLow', 'ScheduleIndexOutOfBounds', 'InvalidScheduleParams']
  },
  /**
   * Lookup577: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<rococo_runtime::RuntimeCall, sp_runtime::traits::BlakeTwo256>, BlockNumber, rococo_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup579: pallet_scheduler::pallet::Error<T>
   **/
  PalletSchedulerError: {
    _enum: ['FailedToSchedule', 'NotFound', 'TargetBlockNumberInPast', 'RescheduleNoChange', 'Named']
  },
  /**
   * Lookup582: pallet_proxy::ProxyDefinition<sp_core::crypto::AccountId32, rococo_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup586: pallet_proxy::Announcement<sp_core::crypto::AccountId32, primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup588: pallet_proxy::pallet::Error<T>
   **/
  PalletProxyError: {
    _enum: ['TooMany', 'NotFound', 'NotProxy', 'Unproxyable', 'Duplicate', 'NoPermission', 'Unannounced', 'NoSelfProxy']
  },
  /**
   * Lookup590: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32, MaxApprovals>
   **/
  ...
  /**
   * Lookup592: pallet_multisig::pallet::Error<T>
   **/
  PalletMultisigError: {
    _enum: ['MinimumThreshold', 'AlreadyApproved', 'NoApprovalsNeeded', 'TooFewSignatories', 'TooManySignatories', 'SignatoriesOutOfOrder', 'SenderInSignatories', 'NotFound', 'NotOwner', 'NoTimepoint', 'WrongTimepoint', 'UnexpectedTimepoint', 'MaxWeightTooLow', 'AlreadyStored']
  },
  /**
   * Lookup593: pallet_preimage::OldRequestStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup596: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32, frame_support::traits::tokens::fungible::HoldConsideration<A, F, R, D>>
   **/
  ...
  /**
   * Lookup602: pallet_preimage::pallet::Error<T>
   **/
  PalletPreimageError: {
    _enum: ['TooBig', 'AlreadyNoted', 'NotAuthorized', 'NotNoted', 'Requested', 'NotRequested', 'TooMany', 'TooFew']
  },
  /**
   * Lookup603: pallet_asset_rate::pallet::Error<T>
   **/
  PalletAssetRateError: {
    _enum: ['UnknownAssetKind', 'AlreadyExists']
  },
  /**
   * Lookup604: pallet_bounties::Bounty<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup605: pallet_bounties::BountyStatus<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup607: pallet_bounties::pallet::Error<T, I>
   **/
  PalletBountiesError: {
  ...
  /**
   * Lookup613: pallet_nis::pallet::Bid<Balance, sp_core::crypto::AccountId32>
   **/
  PalletNisBid: {
    amount: 'u128',
    who: 'AccountId32'
  ...
  /**
   * Lookup615: pallet_nis::pallet::SummaryRecord<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup616: pallet_nis::pallet::ReceiptRecord<sp_core::crypto::AccountId32, BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup618: pallet_nis::pallet::Error<T>
   **/
  PalletNisError: {
  ...
  /**
   * Lookup622: polkadot_runtime_parachains::configuration::HostConfiguration<BlockNumber>
   **/
  ...
  /**
   * Lookup625: polkadot_runtime_parachains::configuration::pallet::Error<T>
   **/
  PolkadotRuntimeParachainsConfigurationPalletError: {
    _enum: ['InvalidNewValue']
  },
  /**
   * Lookup628: polkadot_runtime_parachains::shared::AllowedRelayParentsTracker<primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup631: polkadot_runtime_parachains::inclusion::AvailabilityBitfieldRecord<N>
   **/
  ...
  /**
   * Lookup632: polkadot_runtime_parachains::inclusion::CandidatePendingAvailability<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup633: polkadot_runtime_parachains::inclusion::pallet::Error<T>
   **/
  ...
  /**
   * Lookup634: polkadot_primitives::v6::ScrapedOnChainVotes<primitive_types::H256>
   **/
  ...
  /**
   * Lookup639: polkadot_runtime_parachains::paras_inherent::pallet::Error<T>
   **/
  ...
  /**
   * Lookup642: polkadot_runtime_parachains::scheduler::pallet::CoreOccupied<N>
   **/
  ...
  /**
   * Lookup643: polkadot_runtime_parachains::scheduler::pallet::ParasEntry<N>
   **/
  ...
  /**
   * Lookup644: polkadot_runtime_parachains::scheduler::common::Assignment
   **/
  PolkadotRuntimeParachainsSchedulerCommonAssignment: {
    paraId: 'u32'
  },
  /**
   * Lookup650: polkadot_runtime_parachains::paras::PvfCheckActiveVoteState<BlockNumber>
   **/
  ...
  /**
   * Lookup652: polkadot_runtime_parachains::paras::PvfCheckCause<BlockNumber>
   **/
  ...
  /**
   * Lookup653: polkadot_runtime_parachains::paras::SetGoAhead
   **/
  PolkadotRuntimeParachainsParasSetGoAhead: {
    _enum: ['Yes', 'No']
  },
  /**
   * Lookup656: polkadot_runtime_parachains::paras::ParaLifecycle
   **/
  ...
  /**
   * Lookup658: polkadot_runtime_parachains::paras::ParaPastCodeMeta<N>
   **/
  ...
  /**
   * Lookup660: polkadot_runtime_parachains::paras::ReplacementTimes<N>
   **/
  ...
  /**
   * Lookup662: polkadot_primitives::v6::UpgradeGoAhead
   **/
  PolkadotPrimitivesV6UpgradeGoAhead: {
    _enum: ['Abort', 'GoAhead']
  },
  /**
   * Lookup663: polkadot_primitives::v6::UpgradeRestriction
   **/
  PolkadotPrimitivesV6UpgradeRestriction: {
    _enum: ['Present']
  },
  /**
   * Lookup664: polkadot_runtime_parachains::paras::pallet::Error<T>
   **/
  ...
  /**
   * Lookup666: polkadot_runtime_parachains::initializer::BufferedSessionChange
   **/
  ...
  /**
   * Lookup668: polkadot_core_primitives::InboundDownwardMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup669: polkadot_runtime_parachains::hrmp::HrmpOpenChannelRequest
   **/
  ...
  /**
   * Lookup671: polkadot_runtime_parachains::hrmp::HrmpChannel
   **/
  ...
  /**
   * Lookup673: polkadot_core_primitives::InboundHrmpMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup676: polkadot_runtime_parachains::hrmp::pallet::Error<T>
   **/
  ...
  /**
   * Lookup678: polkadot_primitives::v6::SessionInfo
   **/
  ...
  /**
   * Lookup679: polkadot_primitives::v6::IndexedVec<polkadot_primitives::v6::ValidatorIndex, polkadot_primitives::v6::validator_app::Public>
   **/
  PolkadotPrimitivesV6IndexedVecValidatorIndex: 'Vec<PolkadotPrimitivesV6ValidatorAppPublic>',
  /**
   * Lookup681: polkadot_primitives::v6::IndexedVec<polkadot_primitives::v6::GroupIndex, V>
   **/
  PolkadotPrimitivesV6IndexedVecGroupIndex: 'Vec<Vec<u32>>',
  /**
   * Lookup683: polkadot_primitives::v6::DisputeState<N>
   **/
  ...
  /**
   * Lookup685: polkadot_runtime_parachains::disputes::pallet::Error<T>
   **/
  ...
  /**
   * Lookup686: polkadot_primitives::v6::slashing::PendingSlashes
   **/
  ...
  /**
   * Lookup690: polkadot_runtime_parachains::disputes::slashing::pallet::Error<T>
   **/
  ...
  /**
   * Lookup691: pallet_message_queue::BookState<polkadot_runtime_parachains::inclusion::AggregateMessageOrigin>
   **/
  ...
  /**
   * Lookup693: pallet_message_queue::Neighbours<polkadot_runtime_parachains::inclusion::AggregateMessageOrigin>
   **/
  ...
  /**
   * Lookup695: pallet_message_queue::Page<Size, HeapSize>
   **/
  ...
  /**
   * Lookup697: pallet_message_queue::pallet::Error<T>
   **/
  PalletMessageQueueError: {
    _enum: ['NotReapable', 'NoPage', 'NoMessage', 'AlreadyProcessed', 'Queued', 'InsufficientWeight', 'TemporarilyUnprocessable', 'QueuePaused']
  },
  /**
   * Lookup699: polkadot_runtime_parachains::assigner_on_demand::CoreAffinityCount
   **/
  ...
  /**
   * Lookup700: polkadot_runtime_parachains::assigner_on_demand::pallet::Error<T>
   **/
  ...
  /**
   * Lookup701: polkadot_runtime_common::paras_registrar::ParaInfo<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup727: xcm::VersionedAssetId
   **/
  XcmVersionedAssetId: {
    _enum: {
      __Unused0: 'Null',
  ...
  /**
   * Lookup728: pallet_xcm::pallet::RemoteLockedFungibleRecord<ConsumerIdentifier, MaxConsumers>
   **/
  ...
  /**
   * Lookup735: pallet_xcm::pallet::Error<T>
   **/
  PalletXcmError: {
  ...
  /**
   * Lookup736: polkadot_runtime_common::paras_sudo_wrapper::pallet::Error<T>
   **/
  ...
  /**
   * Lookup737: polkadot_runtime_common::assigned_slots::ParachainTemporarySlot<sp_core::crypto::AccountId32, LeasePeriod>
   **/
  ...
  /**
   * Lookup738: polkadot_runtime_common::assigned_slots::pallet::Error<T>
   **/
  ...
  /**
   * Lookup739: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  ...
  /**
   * Lookup751: rococo_runtime::Runtime
   **/
